...
<html lang="es">
  ...
  <body>
    ...
    <div class="container">
      ...
      <main>  
          <div class="formu">
            <p>Esta sección sólo estará disponible en un futuro para el administrador de la web y será para insertar nuevos regalos a la lista y que los usuarios puedan verlos y seleccionarlos. Está enlazada con nuestra base de datos.</p>
          </div>
      </main>
